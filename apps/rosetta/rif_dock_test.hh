...
OPT_1GRP_KEY(     StringVector , rif_dock, scaffolds )
	...
	OPT_1GRP_KEY(  Boolean     , rif_dock, zrosetta_filter_before )
	...
	OPT_1GRP_KEY(  StringVector, rif_dock, cst_files )
		...
		void register_options() {
			...
			NEW_OPT(  rif_dock::zrosetta_filter_before, "redundancy filter results before rosetta score", false );
...
#define INCLUDED_rif_dock_test_hh_4 
	...
	void RifDockOpt::init_from_cli()
	{
		...
		zrosetta_filter_before                  = option[rif_dock::zrosetta_filter_before                 ]();
