...
#ifndef INCLUDED_riflib_task_SearchPointTask_hh
#define INCLUDED_riflib_task_SearchPointTask_hh
...
struct SearchPointTask : public Task {
    ...
    SearchPointWithRots return_search_point_with_rotss( std::vector<SearchPointWithRots> const & search_point_with_rotss ) override;
